				...
				<div class="col-md-3 col-sm-6 col-xs-6" style=" height: 460px;">
					<div class="product product-single">
						<div class="product-thumb" >
							<button class="main-btn quick-view" onclick="location.href='productView?number=${recentlist.productno}'"><i class="fa fa-search-plus"></i> 상세보기</button>
							<img src="${pageContext.request.contextPath}/resources/fileupload/${recentlist.photo1}" alt="" style="width:270px; height: 270px;">
						</div>
						<div class="product-body">
							<h3 class="product-price"><fmt:formatNumber value="${recentlist.price}" pattern="#,###.##"/>원</h3>
							<h2 class="product-name"><a href="#">${recentlist.trade_name}</a></h2>
							<h5 style="color:#999">조회수 : ${recentlist.hit }</h5>
