...
<img id="profileImg" class="img-fluid"
					src="${pageContext.request.contextPath}/resources/profilepic/${member.profile}" style = "display:none">
<input type="text" id="nickname" value = "${member_name }" style = "display:none">
...
<script type="text/javascript">
 ...
 function send() {
  ...
  if(msg != ""){
	  ...
	  message.TUTOR_USER_id = '${TUTOR_USER_user_id}';
	  message.USER_id = '${member.id}';
	  message.CLASS_class_id = '${class_id}';
	  message.message_sender = '${member.id}';
  }
