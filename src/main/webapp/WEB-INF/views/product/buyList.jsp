...
<body>
					...
					<div >
                          <table class="table" id="table">
							    ...
							    <c:forEach var="result" items="${buyList }" varStatus="status">
								 <tr>
								    <td>
								    	<p style="margin-top: 40px;"><strong>${result.sys_date }</strong></p> 
								    ...
								    <c:if test="${result.result==1}">
								    	<h4 style="margin-top: 50px;">배송준비중</h4>
								    </c:if>
								    <c:if test="${result.result==2}">
								    	<h4 style="color:blue; margin-top: 50px;">배송 시작</h4>
								    ...
								    <c:if test="${result.result==3}">
								    	<h4 style="margin-top: 50px;">배송완료</h4>
								    	<button style="font-size: 12px;padding:0; " >배송추적</button>
								    </c:if>
								    </td>
								    <td>
								    <c:if test="${result.result==1}">
								   	 <button style="font-size: 12px;padding:0;margin-top: 50px;margin-left: 15px; ">배송취소하기</button>
								    </c:if>
								    <c:if test="${result.result==2}">
								    	<button style="font-size: 12px;padding:0; margin-top: 50px;margin-left: 15px;">리뷰쓰기</button>
								    	<button style="font-size: 12px;padding:0;margin-left: 15px; ">반품신청</button>
								    </c:if>
								    <c:if test="${result.result==3}">
								   		<button style="font-size: 12px;margin-top: 50px;margin-left: 15px;">리뷰쓰기</button>
								    </c:if>
								    </td>
							    </tr>
	...
	<c:if test="${sessionScope.loginIdDivision eq 5}">
			<div>
				<jsp:include page="/WEB-INF/views/member/statistic.jsp"/>
			</div>
		</c:if>
	<!-- FOOTER -->
	<div>
