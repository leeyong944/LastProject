...
<div id="breadcrumb">
		<div class="container">
         ...
         <!-- 옵션 영역 -->                                         
							...
							<button id="addItemBtn" ><h4 class="title">상세옵션 추가</h4></button> 
									    ...
									    <c:forEach var="result" items="${list }" varStatus="status">
									        <tr class="item${status.count }">
									            <td style="padding:0px;"><input type="text" class="input" style="height:40px;" value="${result.option1 }"/></td>
									            <td style="padding:0px;"><input type="text" class="input" style="height:40px;" value="${result.option2 }"/></td>
									            <td style="padding:0px;"><input type="text"  class="input" style="height:40px;"value="${result.saleprice }"/></td>
									            <td style="padding:0px;"><input type="text"  class="input" style="height:40px;"value="${result.stock }"/></td>
			...
			<form action="productModify" method="post" enctype="multipart/form-data" id="productbuy" >
					<div class="col-md-6">
						<div class="billing-details">
							<div class="section-title">
						...
						<div class="product-img-layout">	
							<div class="product-img-area1" style="background-size:cover;background-repeat:no-repeat; background-size: contain; background-position: center; background-image:url('${pageContext.request.contextPath}/resources/fileupload/${product.photo1}');" id="back-img-1" ></div>
						...
						<!-- 상세이미지 영역 -->
						<div class="product-img-layout">
							<div class="product-img-area1" style="background-size:cover;background-repeat:no-repeat; background-size: contain; background-position: center;  background-image:url('${pageContext.request.contextPath}/resources/fileupload/${product.photo2}');" id="back-img-2"></div>
							<div class="product-img-area1-1" >
						...
						<!-- 내용이미지 영역 -->
						<div class="product-img-layout">
							<div class="product-img-area1" style="background-size:cover;background-repeat:no-repeat; background-size: contain; background-position: center;  background-image:url('${pageContext.request.contextPath}/resources/fileupload/${product.photo3}');" id="back-img-3"></div>
							<div class="product-img-area1-1" >
			...
			<div class="col-md-12">
                    ...
                    <input type="hidden" value="${product.photo1}" name="photo7">
					<c:if test="${product.photo2 ne null}">
						<input type="hidden" value="${product.photo2}" name="photo8">
					</c:if>
					<c:if test="${product.photo3 ne null}">
						<input type="hidden" value="${product.photo3}" name="photo9">
					</c:if>
                    	...
                    	<table class="shopping-cart-table table">
                    		<tr>
                    			...
                    			<td><select class="input search-categories" style="height:30px; width:200px;" name="categoryno">
                    					<option value="${product.categoryno }">상품분류*</option>
                    			...
                    			<td>상품가격 : </td>
                    			<td><input type="text" class="input" style="height:30px; width:200px;" placeholder="상품가격*" name="price" value="${product.price }"/></td>
                    		</tr>
                    		<tr>
                    			<td>상품명 : </td>
                    			<td><input type="text" class="input" style="height:30px; width:200px;" placeholder="상품명*" name="trade_name" value="${product.trade_name }"/></td>
                    			<td>상품가격 : </td>
                    ...
                    <div class="col-md-10" style="margin-left:80px;">
                    	<textarea id="summernote" rows="5" name="explanation" style="width:100%; height:250px;">${product.explanation }</textarea>
                    </div>
               </div>
					</form>
					<div class="col-md-10" style="height:100px; text-align:center;margin-top:40px;margin-left:80px;">
						<button id="productModify" class="primary-btn" onclick="productModify()">저장</button>
